    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <div style={{width:64,height:64,backgroundColor:rose,borderRadius:12}} />
          <div style={{display:'flex',flexDirection:'column'}}>
            <div style={{fontSize: 48, fontWeight: 700}}>Coffee Pastel Portfolio</div>
            <div style={{fontSize: 28, opacity: 0.8}}>Minimal • TH/EN • Next.js 14</div>
          </div>
        </div>
      </div>
    ),
